...
checks = [
    ...
    (source, "constexpr size_t kFixedFileChunkSize",
    ...
    (source, "Esp32BaseWatchdog::removeCurrentTaskForLongOperation()",
     "src/runtime/Esp32BaseFs.inc: fixed file creation must protect long flash operation from task WDT"),
    (source, "yield();",
     "src/runtime/Esp32BaseFs.inc: fixed file creation must yield between chunks"),
