...
python3 scripts/pio_arduino.py 2 run -d examples/record_store -e esp32
python3 scripts/pio_arduino.py 2 run -d examples/record_store -e esp32s3
python3 scripts/pio_arduino.py 2 run -d examples/record_store -e esp32c3
python3 scripts/pio_arduino.py 3 run -d examples/record_store -e esp32_arduino3
```
