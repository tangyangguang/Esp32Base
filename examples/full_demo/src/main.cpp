...
#define RUN_BOOL(expr) do { ++total; if (expr) ++pass; } while (0)
    ...
    RUN_SELFTEST("GET", "/esp32base", nullptr, true, 200, "<header class='pagehead'><h1>Full Demo</h1></header><div class='statusgrid'><section class='panel statuspage'><h2>System Overview</h2>");
