...
#define RUN_BOOL(expr) do { ++total; if (expr) ++pass; } while (0)
    ...
    RUN_SELFTEST("GET", "/esp32base", nullptr, true, 200, "tablewrap");
    RUN_SELFTEST("GET", "/esp32base", nullptr, true, 200, "class='kv'");
    ...
    RUN_SELFTEST("GET", "/esp32base", nullptr, true, 200, "<h1>Full Demo</h1>");
    ...
    RUN_SELFTEST("GET", "/esp32base/wifi", nullptr, true, 200, "wifipanel");
    RUN_SELFTEST("GET", "/esp32base/wifi", nullptr, true, 200, "Credentials");
    RUN_SELFTEST("GET", "/esp32base/wifi", nullptr, true, 200, "class='editform'");
    RUN_SELFTEST("GET", "/esp32base/wifi", nullptr, true, 200, "dangerpanel");
    RUN_SELFTEST("GET", "/esp32base/wifi", nullptr, true, 200, "Clear WiFi");
    ...
    RUN_SELFTEST("GET", "/esp32base/logs", nullptr, true, 200, "logpanel");
    RUN_SELFTEST("GET", "/esp32base/logs", nullptr, true, 200, "class='logmeta'");
    RUN_SELFTEST("GET", "/esp32base/logs", nullptr, true, 200, "System logs</th>");
    RUN_SELFTEST("GET", "/esp32base/logs", nullptr, true, 200, "tag ok");
    ...
    RUN_SELFTEST("GET", "/esp32base/logs", nullptr, true, 200, "Max per file</th>");
    RUN_SELFTEST("GET", "/esp32base/logs", nullptr, true, 200, "32.00 KB");
    RUN_SELFTEST("GET", "/esp32base/logs", nullptr, true, 200, "Open raw log</a>");
    RUN_SELFTEST("GET", "/esp32base/logs", nullptr, true, 200, "class='active'");
    RUN_SELFTEST("GET", "/esp32base/logs", nullptr, true, 200, "href='/esp32base/logs?segment=0'");
    RUN_SELFTEST("GET", "/esp32base/logs", nullptr, true, 200, "current-0");
    RUN_SELFTEST("GET", "/esp32base/logs?segment=1", nullptr, true, 200, "history-1");
    RUN_SELFTEST("GET", "/esp32base/logs?segment=99", nullptr, true, 200, "class='active'");
    RUN_SELFTEST("GET", "/esp32base/logs?segment=99", nullptr, true, 200, "href='/esp32base/logs?segment=0'");
    RUN_SELFTEST("GET", "/esp32base/logs?segment=99", nullptr, true, 200, "current-0");
    ...
    RUN_SELFTEST("GET", "/esp32base/auth", nullptr, true, 200, "authpanel");
    RUN_SELFTEST("GET", "/esp32base/auth", nullptr, true, 200, "Credentials");
    RUN_SELFTEST("GET", "/esp32base/auth", nullptr, true, 200, "class='editform'");
    ...
    RUN_SELFTEST("GET", "/esp32base/ota", nullptr, true, 200, "OTA diagnostics");
    RUN_SELFTEST("GET", "/esp32base/ota", nullptr, true, 200, "tablewrap");
    RUN_SELFTEST("GET", "/esp32base/ota", nullptr, true, 200, "class='kv'");
    RUN_SELFTEST("GET", "/esp32base/ota", nullptr, true, 200, "uploadpanel");
    RUN_SELFTEST("GET", "/esp32base/ota", nullptr, true, 200, "Firmware upload");
    RUN_SELFTEST("GET", "/esp32base/tools", nullptr, true, 200, "<title>System</title>");
    RUN_SELFTEST("GET", "/esp32base/tools", nullptr, true, 200, "actionpanel");
    ...
    RUN_SELFTEST("GET", "/esp32base/tools", nullptr, true, 200, "hostpanel");
    ...
    RUN_SELFTEST("GET", "/esp32base/tools", nullptr, true, 200, "dangerpanel");
    ...
    RUN_SELFTEST("GET", "/esp32base/app-config", nullptr, true, 200, "id='acbox' class='confirmbox'");
    ...
    RUN_SELFTEST("GET", "/control/edit", nullptr, true, 200, "footerbar");
    RUN_SELFTEST("GET", "/control/edit", nullptr, true, 200, "syslinks");
