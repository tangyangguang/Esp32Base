...
#define RUN_CROSS_ORIGIN_SELFTEST(method, path, body, auth, code, contains) \
    ...
    RUN_SELFTEST("GET", "/esp32base/ui.css", nullptr, true, 200, "--eb-primary-hover");
    RUN_SELFTEST("GET", "/esp32base/ui.css", nullptr, true, 200, ".tablewrap");
    RUN_SELFTEST("GET", "/esp32base/ui.css", nullptr, true, 200, ".statusgrid");
    RUN_SELFTEST("GET", "/esp32base/ui.css", nullptr, true, 200, ".btnlink,input.btnlink");
