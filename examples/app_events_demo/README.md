...
python3 scripts/pio_arduino.py 2 run -d examples/app_events_demo
python3 scripts/pio_arduino.py 2 run -d examples/app_events_demo -e esp32s3_local
python3 scripts/pio_arduino.py 2 run -d examples/app_events_demo -e esp32c3_local
python3 scripts/pio_arduino.py 3 run -d examples/app_events_demo -e esp32_local_arduino3
python3 scripts/pio_arduino.py 2 run -d examples/app_events_demo -e esp32_local_discrete_only
```
