...
- Storage & Logs 新增 File inventory 和 Largest files 摘要，显示文件数、目录数、已统计文件大小、other/overhead 和 Top 5 最大文件，便于判断 LittleFS 满盘来源。
- 新增只读 `/esp32base/fs` 详情页，显示 Summary、Top 10 最大文件和最多 128 项文件树；不提供删除、下载、编辑或格式化入口。
