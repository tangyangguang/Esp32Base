...
void handleOtaUploadDone() {
    ...
    if (ok) {
        if (beginResponse(200, "application/json", nullptr)) {
            ...
            sendEscapedJsonChunk("/esp32base/status");
            sendChunk("\",\"rssi\":");
