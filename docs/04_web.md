...
- Runtime Health 显示 heap free/min/max alloc/total、Watchdog、NTP time、last reset 和 last wake。
...
- `/esp32base` 系统页按 Device、Network、Runtime Health、Storage & Logs、Firmware & OTA、Hardware、Partition Table 展示设备调试信息，包括 STA/AP/eFuse MAC、OTA slot minus current sketch、last reset/wake 和运行时分区表。
